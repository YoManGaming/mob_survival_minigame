...
minetest.register_tool("arena_lib:settings_returnpoint", {
  ...
  on_use = function(itemstack, user, pointed_thing)
    ...
    local rotation    = {x = math.deg(user:get_look_horizontal()), y = math.deg(user:get_look_vertical())}

    arena_lib.set_custom_return_point(p_name, mod, arena_name, vector.round(user:get_pos()), rotation, true)
  end,
  ...
  on_secondary_use = function(itemstack, user, pointed_thing)
    ...
    arena_lib.set_custom_return_point(p_name, mod, arena_name, nil, nil, true)
  end,
