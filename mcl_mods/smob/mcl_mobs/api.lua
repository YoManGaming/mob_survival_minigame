...
function mcl_mobs.register_on_kill(func)
    table.insert(mcl_mobs.callbacks, func)
end


function mcl_mobs.exec_global_callbacks(mob_name, killer)
    for i, callback in pairs(mcl_mobs.callbacks) do
