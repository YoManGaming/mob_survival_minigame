...
local al_S = minetest.get_translator("arena_lib")
...
function hub.edit_celvault(p_name)
  ...
  minetest.show_formspec(p_name, "hub:celestial_vault", get_celvault_formspec(p_name, "sky"))
end
...
minetest.register_on_player_receive_fields(function(player, formname, fields)
  ...
  elseif fields.reset then
    ...
    elseif fields.sun_size then
      minetest.show_formspec(p_name, "hub:celestial_vault", get_celvault_formspec(p_name, "sun"))
    elseif fields.moon_size then
      minetest.show_formspec(p_name, "hub:celestial_vault", get_celvault_formspec(p_name, "moon"))
    elseif fields.stars_count then
      minetest.show_formspec(p_name, "hub:celestial_vault", get_celvault_formspec(p_name, "stars"))
    else
      minetest.show_formspec(p_name, "hub:celestial_vault", get_celvault_formspec(p_name, "clouds"))
    end
