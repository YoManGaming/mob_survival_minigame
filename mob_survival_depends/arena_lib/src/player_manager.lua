...
minetest.register_on_punchplayer(function(player, hitter, time_from_last_punch, tool_capabilities, dir, damage)
  ...
  -- TEMP: non ce ne sarebbe neanche bisogno, serve https://github.com/minetest/minetest/issues/14742
  if not p_arena and not t_arena then
    return
  end

  -- se chi dà il pugno è spettante, annulla (posson farlo in 3° persona)
...
minetest.register_on_respawnplayer(function(player)
  ...
  if arena_lib.is_player_spectating(p_name) then -- lɜ spettanti non dovrebbero proprio morire, ma in caso...
